...
class CheckoutActivity: AppCompatActivity() , HyperInterface {
    ...
    private var serverUrl = "http://10.0.2.2:5252"    // Replace the IP(10.0.2.2) address with your IP.
    private lateinit var paymentSession: PaymentSession
    private lateinit var paymentSessionLite: io.hyperswitch.lite.PaymentSession
                ...
                override fun success(value: String?) {
                    try {
                        ...
                        if (result != null) {
                            ...
                            paymentSessionLite = io.hyperswitch.lite.PaymentSession(ctx, publishKey)
